	...
	\chapter{Entropia e Informazione} %CAPITOLO 2
		...
		\section{Probabilità}
			...
			\subsection{Matrice stocastica}
				Per capire una sequenza bisogna conoscerne la \textit{memoria}, ossia tutte le dipendenze di un evento dagli altri.
		...
		\section{Entropia}
			...
			\begin{equation}
				\delta H=-\sum_{i}\delta p(x_i)\ln p(x_i)+\lambda\sum_{j}x_{j}\delta p_{j}
			\end{equation}
